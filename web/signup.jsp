		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<h2>Get Registered for your account</h2>
                                        <form class="form-horizontal" action="controller/register_c.jsp" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Password">
								...
								<input class="input-large span10" name="password" id="password" type="password" placeholder="type password" autocomplete="off"/>
							</div>
							<div class="clearfix"></div>
					...
					<h3>Registered?</h3>
					<p>
						No problem, <a href="login.jsp">login</a> 
					</p>	
				</div><!--/span-->
			</div><!--/row-->
