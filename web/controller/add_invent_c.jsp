        ...
        try
            {
                    ...
                    {
                       query = "update stock set status='Inactive' where stockid='"+request.getParameter("del")+"'";
                          out.println(query);
                          s1.executeUpdate(query);
                        response.sendRedirect("../index.jsp?mo=view_inventory");
                    }
                    ...
                    double sp=Double.parseDouble(request.getParameter("original"));
                    ...
                    query="update sale set saledate='"+sd+"', contactid='"+contid+"',itemid='"+iid+"',categiryid='"+cateid+"',sp='"+sp+"',qty='"+qt+"',subtotal='"+stot+"', where saleid='"+request.getParameter("hid_edit")+"';";
                      out.println(query);
                    s1.executeUpdate(query);
                                                                    ...
                                                                    Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/inventory?zeroDateTimeBehavior=convertToNull","root","");
                                                                     ...
                                                                     { r=1;
                                                                      break;
                                                                            ...
                                                                            query="insert into location values(null,'"+iid+"','"+contid+"','"+session.getAttribute("uid")+"',now(),'"+session.getAttribute("uid")+"',now(),'Active')";
                   out.println(query);
                    s1.executeUpdate(query);
                    response.sendRedirect("../index.jsp?mo=view_inventory");}
