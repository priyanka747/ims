        ...
        <%! double nw=0;%>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Category wise Report</h2>
							  ...
							  <tbody>
                                                              <%
                                                                   try
                                                                   {
                                                                    ...
                                                                    Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/inventory?zeroDateTimeBehavior=convertToNull","root","");
                                                                     ...
                                                                     String query="SELECT * FROM stock WHERE STATUS != 'Inactive' order by categoryid";
								...
								<tr>
								     ...
								     <%}}
                                                         ...
                                                         <h3>you have<font color="red>" ><%=i%> quantity </font> of all category worth of <%=nw%> </h3>
