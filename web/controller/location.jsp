    ...
    %>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Item:<%=lc%></h2>
							  ...
							  <tbody>
                                                              <%
                                                                   ...
                                                                   try
                                                                   {
                                                                    ...
                                                                    Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/inventory?zeroDateTimeBehavior=convertToNull","root","");
                                                                     ...
                                                                     String query="SELECT * FROM stock WHERE STATUS != 'Inactive' and locationid='"+lc+"'";
								...
								<tr>
								     ...
								     <%}}
                                                                                                                                                                    ...
                                                                                                                                                                    <h3>you have<font color="red>" ><%=i%> quantity </font> at the this location total of <%=nw%><!--<%=lc%>--> </h3>
					</div>
				</div><!--/span-->
			</div><!--/row-->
  <div>
