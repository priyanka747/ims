    ...
    %>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Item:<%=it%></h2>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                                                              ...
                                                              <%
                                                                   ...
                                                                   try
                                                                   {
                                                                    ...
                                                                    Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/inventory?zeroDateTimeBehavior=convertToNull","root","");
                                                                     ...
                                                                     String query="SELECT * FROM stock WHERE STATUS != 'Inactive' and itemid='"+it+"'";
						    ...
						    <h3>you have<font color="red>" ><%=i%> quantity </font> of this item worth of <%=nw%> </h3>
					</div>
				</div><!--/span-->
			</div><!--/row-->
